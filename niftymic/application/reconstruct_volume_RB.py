...
# \date       March 2017
#
# Simplified version for testing - volume based registration rather than slice based
...
def main():
    ...
    if args.two_step_cycles > 0:
        ...
        two_step_v2v_reg_recon = \
            pipeline.TwoStepVolumeToVolumeRegistrationReconstruction(
                stacks=stacks,
                reference=HR_volume,
        ...
        HR_volume_iterations = \
            two_step_v2v_reg_recon.get_iterative_reconstructions()
        time_registration += \
            two_step_v2v_reg_recon.get_computational_time_registration()
        time_reconstruction += \
            two_step_v2v_reg_recon.get_computational_time_reconstruction()
        stacks = two_step_v2v_reg_recon.get_stacks()

    # no two-step v2v-registration/reconstruction iterations
    else:
        HR_volume_iterations = []
